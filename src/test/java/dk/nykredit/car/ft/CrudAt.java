package dk.nykredit.car.ft;

import dk.nykredit.car.CarBean;
import dk.nykredit.car.ft.pages.LogonDialog;
import dk.nykredit.car.util.DBUnitUtils;
import dk.nykredit.car.ft.pages.IndexPage;
...
public class CrudAt {
    ...
    @Deployment(name = "nykredit-car.war", testable = false)
    public static Archive<?> createDeployment() {
        ...
        war.addAsResource(new File("src/main/resources/car.properties"), "crud.properties");
